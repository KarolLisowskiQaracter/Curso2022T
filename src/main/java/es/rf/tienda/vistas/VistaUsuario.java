	...
	public void actionPerformed(ActionEvent e) {
		...
		if (comando.equals("CrearUsuarioPantalla")) {
			...
			if (!idText.getText().equals("") && !nombreText.getText().equals("") && !emailText.getText().equals("")
					&& !contraseñaText.getText().equals("") && !tipoUsuarioText.getText().equals("")
					&& !dniText.getText().equals("")) {
				Usuario usuario = new Usuario(Integer.parseInt(idText.getText()), nombreText.getText(),
						emailText.getText(), contraseñaText.getText(), Integer.parseInt(tipoUsuarioText.getText()),
						dniText.getText());
